; StereoProcessor installer (Inno Setup)

#define MyAppName "StereoProcessor"
...
#define MyAppVersion GetStringFileInfo("bin\VST3\StereoProcessor.vst3\Contents\x86_64-win\StereoProcessor.vst3", "ProductVersion")
#define MyDefaultDirName "{commoncf64}\VST3"

[Setup]
AppID={{204A1496-BB1D-4348-805F-41CD3955A294}
...
OutputDir=.\bin
OutputBaseFilename=StereoProcessor
...
Source: "bin\CrashReporter\stereoprocessor.json";   DestDir: "{commonappdata}\Rabien Software\Crash Reporter\Plugins"; Flags: ignoreversion uninsneveruninstall
