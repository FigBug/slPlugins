...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST\Crossfeed.dll";   Components: vst
...
[Files]
Source: "bin\VST\Crossfeed.dll";    DestDir: "{commoncf64}\VST";                Flags: ignoreversion overwritereadonly; Components: vst
