...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST\ToneGenerator.dll";   Components: vst
...
[Files]
Source: "bin\VST\ToneGenerator.dll";    DestDir: "{commoncf64}\VST";                Flags: ignoreversion overwritereadonly; Components: vst
