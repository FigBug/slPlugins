...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST2\Gate.dll";   Components: vst
...
[Files]
Source: "bin\VST\Gate.dll";    DestDir: "{commoncf64}\VST2";                Flags: ignoreversion overwritereadonly; Components: vst
...
Source: "bin\CrashReporter\gate.json";   DestDir: "{commonappdata}\Rabien Software\Crash Reporter\Plugins"; Flags: ignoreversion uninsneveruninstall
