...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST\Oscilloscope.dll";   Components: vst
...
[Files]
Source: "bin\VST\Oscilloscope.dll";    DestDir: "{commoncf64}\VST";                Flags: ignoreversion overwritereadonly; Components: vst
