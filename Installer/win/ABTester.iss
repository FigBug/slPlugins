...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST2\ABTester.dll";   Components: vst
...
[Files]
Source: "bin\VST\ABTester.dll";    DestDir: "{commoncf64}\VST2";                Flags: ignoreversion overwritereadonly; Components: vst
...
Source: "bin\CrashReporter\abtester.json";   DestDir: "{commonappdata}\Rabien Software\Crash Reporter\Plugins"; Flags: ignoreversion uninsneveruninstall
