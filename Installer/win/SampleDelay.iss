...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST\SampleDelay.dll";   Components: vst
...
[Files]
Source: "bin\VST\SampleDelay.dll";    DestDir: "{commoncf64}\VST";                Flags: ignoreversion overwritereadonly; Components: vst
