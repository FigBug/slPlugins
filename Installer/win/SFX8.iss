...
[InstallDelete]
Type: files;          Name: "{commoncf64}\VST\SFX8.dll";   Components: vst
...
[Files]
Source: "bin\VST\SFX8.dll";    DestDir: "{commoncf64}\VST";                Flags: ignoreversion overwritereadonly; Components: vst
