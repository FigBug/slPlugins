...
namespace
{
    juce::File userResourceRoot()
    {
        ...
        return juce::File::getSpecialLocation (juce::File::userHomeDirectory)
                  .getChildFile ("Library/Audio/Presets/SocaLabs/Gate");
       #elif JUCE_WINDOWS
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
                  .getChildFile ("SocaLabs/Gate");
       #else
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
                  .getChildFile ("SocaLabs/Gate");
       #endif
    ...
    {
       #if JUCE_MAC
        return juce::File ("/Library/Audio/Presets/SocaLabs/Gate");
       #elif JUCE_WINDOWS
        return juce::File::getSpecialLocation (juce::File::commonApplicationDataDirectory)
                  .getChildFile ("SocaLabs/Gate");
       #else
        return juce::File ("/usr/share/SocaLabs/Gate");
       #endif
    }
    ...
    juce::File legacyUserProgramDirectory()
    {
       #if JUCE_MAC
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
                  .getChildFile ("Application Support/com.socalabs/Gate/programs");
       #else
        return juce::File::getSpecialLocation (juce::File::userApplicationDataDirectory)
                  .getChildFile ("com.socalabs/Gate/programs");
       #endif
    }
}
...
//==============================================================================
juce::File GateAudioProcessor::getProgramDirectory()
{
...
juce::Array<juce::File> GateAudioProcessor::getFactoryProgramDirectories()
{
